...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> sameRoleException(SameRoleException ex, WebRequest request) {
	...
	@ExceptionHandler(UserTodoMismatchException.class)
	public ResponseEntity<?> userTodoMismatchException(UserTodoMismatchException ex, WebRequest request) {
